...
import com.amar.covid19arunachalpradesh.Adapters.MainRecyclerAdapter;
import com.amar.covid19arunachalpradesh.CollectionFood.CollectionFoodMain;
import com.amar.covid19arunachalpradesh.HealthWorkerAssigning.HealthWorkerAssigning;
import com.amar.covid19arunachalpradesh.MigrantLabour.LabourDetails;
import com.amar.covid19arunachalpradesh.Orphan.OrphanHome;
import com.amar.covid19arunachalpradesh.Unorganizedworker.UnorganizedMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        travelcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://eservice.arunachal.gov.in/"));
