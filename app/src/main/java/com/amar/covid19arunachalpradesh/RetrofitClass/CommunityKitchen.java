...
import com.amar.covid19arunachalpradesh.Adapters.CommunityKitchenAdapter;
import com.amar.covid19arunachalpradesh.ApiInterface.ApiResources;
        ...
        call.enqueue(new Callback<Covid19Resources>() {
            ...
            public void onResponse(Response<Covid19Resources> response) {
                ...
                for (int i=0;i<resources.size();i++) {
                    ...
                    String checkstate = "Arunachal Pradesh";
